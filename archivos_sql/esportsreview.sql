...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-04-2018 a las 14:04:15
...
INSERT INTO `comentarios` (`id_comentario`, `usuario`, `contenido`, `videojuego`, `fecha_comentario`) VALUES
...
--
ALTER TABLE `comentarios`
  ADD CONSTRAINT `comentarios_ibfk_1` FOREIGN KEY (`usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
